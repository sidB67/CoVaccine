...
class _DistrictSearchState extends State<DistrictSearch> {
  ...
  Widget build(BuildContext context) {
    final districtSessions = Provider.of<SessionsData>(context).districtSessions;
    final states = Provider.of<SessionsData>(context).states;
    final districts = Provider.of<SessionsData>(context).districts;
            ...
            child: Column(
              ...
              children: [
                ...
                Center(
                  child: Container(
                    margin:
                        EdgeInsets.only(top: SizeConfig.safeBlockVertical * 20,bottom: SizeConfig.safeBlockVertical * 8),
